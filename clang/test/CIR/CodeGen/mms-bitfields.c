// RUN: %clang_cc1 -triple x86_64-pc-win32 -mms-bitfields -fclangir -emit-cir %s -o %t.cir
// RUN: FileCheck --input-file=%t.cir %s --check-prefix=CIR
// RUN: %clang_cc1 -triple x86_64-pc-win32 -mms-bitfields -fclangir -emit-llvm %s -o %t-cir.ll
// RUN: FileCheck --input-file=%t-cir.ll %s --check-prefix=LLVM
// RUN: %clang_cc1 -triple x86_64-pc-win32 -mms-bitfields -emit-llvm %s -o %t.ll
